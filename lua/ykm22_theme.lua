...
local function get_groups()
	...
	local groups = {
		...
		ykm22RedSign = config.transparent_mode and { fg = colors.red, reverse = config.invert_signs }
		or { fg = colors.red, bg = colors.bg1, reverse = config.invert_signs },
		ykm22GreenSign = config.transparent_mode and { fg = colors.green, reverse = config.invert_signs }
		or { fg = colors.green, bg = colors.bg1, reverse = config.invert_signs },
		ykm22YellowSign = config.transparent_mode and { fg = colors.yellow, reverse = config.invert_signs }
		or { fg = colors.yellow, bg = colors.bg1, reverse = config.invert_signs },
		ykm22BlueSign = config.transparent_mode and { fg = colors.blue, reverse = config.invert_signs }
		or { fg = colors.blue, bg = colors.bg1, reverse = config.invert_signs },
		ykm22PurpleSign = config.transparent_mode and { fg = colors.purple, reverse = config.invert_signs }
		or { fg = colors.purple, bg = colors.bg1, reverse = config.invert_signs },
		ykm22AquaSign = config.transparent_mode and { fg = colors.aqua, reverse = config.invert_signs }
		or { fg = colors.aqua, bg = colors.bg1, reverse = config.invert_signs },
		ykm22OrangeSign = config.transparent_mode and { fg = colors.orange, reverse = config.invert_signs }
		or { fg = colors.orange, bg = colors.bg1, reverse = config.invert_signs },
		ykm22RedUnderline = { undercurl = config.undercurl, sp = colors.red },
		ykm22GreenUnderline = { undercurl = config.undercurl, sp = colors.green },
		ykm22YellowUnderline = { undercurl = config.undercurl, sp = colors.yellow },
		ykm22BlueUnderline = { undercurl = config.undercurl, sp = colors.blue },
		ykm22PurpleUnderline = { undercurl = config.undercurl, sp = colors.purple },
		ykm22AquaUnderline = { undercurl = config.undercurl, sp = colors.aqua },
		ykm22OrangeUnderline = { undercurl = config.undercurl, sp = colors.orange },
		...
		TabLineSel = { fg = colors.fg4, bg = colors.bg2, reverse = config.invert_tabline },
